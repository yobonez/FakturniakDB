USE [FakturniakDB]
GO
/****** Object:  View [dbo].[vMtmFaktury]    Script Date: 11.07.2022 10:03:38 ******/
SET ANSI_NULLS ON
GO
...
SELECT f.numer_faktury, p.nazwa AS 'Produkt', p.cena_netto, st.wartosc AS 'Stawka VAT',p.cena_brutto, mtmp.ilosc AS 'IloϾ', jdn.nazwa AS 'Jednostka', p.cena_brutto * mtmp.ilosc AS 'Suma' 
