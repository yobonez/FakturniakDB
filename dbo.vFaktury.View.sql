USE [FakturniakDB]
GO
/****** Object:  View [dbo].[vFaktury]    Script Date: 11.07.2022 10:03:38 ******/
SET ANSI_NULLS ON
GO
...
SELECT f.numer_faktury, typy.opis AS 'Typ faktury', sp.imie AS 'Sprzedawca', sp.nazwisko AS ' ', nab.imie AS 'Nabywca', nab.nazwisko AS '.', s.nazwa AS 'Sposób p³atnoœci', f.termin_platnosci 
